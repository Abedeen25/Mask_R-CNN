...
ROOT_DIR = os.path.abspath("/content/Mask_R-CNN")
print("VERS 0.2")
# Import Mask RCNN
...
class CustomConfig(Config):
    def __init__(self, num_classes):
        ...
        if num_classes > 1:
            raise ValueError("{} The intended dataset for this code has only 1 defined class. Please make sure the dataset is provided properly".format(num_classes))
